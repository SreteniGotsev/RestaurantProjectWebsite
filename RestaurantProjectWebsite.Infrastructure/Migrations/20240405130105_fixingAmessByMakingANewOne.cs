...
{
    /// <inheritdoc />
    public partial class fixingAmessByMakingANewOne : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsPerOrders", x => x.ProductId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsPerOrders_Products_ProductId",
